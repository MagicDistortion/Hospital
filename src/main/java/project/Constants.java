...
public class Constants {
    ...
    public static final String INSERT_APPOINTMENT_DETAIL = "INSERT INTO appointment_detail (text,nurse_id,appointment_id,doctors_id,hospital_card_id,date) VALUES (?,?,?,?,?,?)";
    ...
    public static final String FROM_APPOINTMENT_DETAIL = "SELECT * FROM appointment_detail left join appointment on appointment_id = appointment.id where hospital_card_id = ? and `status`!='done'";
    public static final String FROM_APPOINTMENTS_FOR_NURSE = "SELECT * FROM appointment_detail left join appointment on appointment_id = appointment.id where nurse_id = ?";
